...
function GetInvolved() {
  return (
    <div className='get-involved'>
      <div className='involved-banner'></div>
      <h2>Get Involved</h2>
      <div className='involved-container'>
        
        <h3>Get Friends to Vote</h3>
          <p>Help encourage your friends and family to excercise their right to vote. Have conversations about why it's important and informed people around you.</p>
